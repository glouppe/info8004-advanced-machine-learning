...
| March 25 | Lecture 8: Denoising Diffusion Probabilistic Models (Antoine Wehenkel)<br>- Paper: _"Denoising Diffusion Probabilistic Models"_, Ho, Jain, Abbeel, 2020 [[link](https://arxiv.org/abs/2006.11239)]<br>- Talk [[slides](https://glouppe.github.io/info8004-advanced-machine-learning/pdf/awehenkel-diffusion.pdf)] |
...
The paper-group assignments are available [here](https://github.com/glouppe/info8004-advanced-machine-learning/blob/master/readings.ipynb). If your name does not appear in the list, please contact us **immediately**, as otherwise you will be marked as Absent for the assignment.
